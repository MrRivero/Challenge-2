...
abs_path = Path(r'sample.env')
load_dotenv(abs_path)

### this will give you access to your environment file
################################################################################
# Step 1:
...
# YOUR CODE HERE
### once it reads the cryptowallet file it finds the g_a
...
# YOUR CODE HERE
#st.sidebar.write(get_balance('world'))
...
# communicated to Ganache, vali dated, and added to a block,
